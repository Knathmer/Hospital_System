...
export default function FinancialOverviewPage() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-8">
      <h1 className="text-3xl font-semibold mb-4">Financial Overview</h1>
      <form
      ...
      >
        ...
        <div className="mt-4 flex space-x-4">
          ...
          <Button
            ...
            className="px-6 py-2 bg-gray-400 text-gray-700 rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400"
          >
            Reset Filters
          </Button>
        </div>
